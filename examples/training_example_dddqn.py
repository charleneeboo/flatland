...
TreeObservation = TreeObsForRailEnv(max_depth=observation_tree_depth, predictor=ShortestPathPredictorForRailEnv(30))
...
agent = DDDQNPolicy(state_size, action_size, None, True).load("2ep")
n_trials = 5
